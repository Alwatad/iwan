...
// Seed data for initial Iwan setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Iwan store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Iwan. All rights reserved.',
  },
  settings: {
    siteName: 'Iwan',
